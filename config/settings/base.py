...
APPS_DIR = ROOT_DIR.path("pythonspain")
...
LOCAL_APPS = [
    ...
    "pythonspain.banks.apps.BanksAppConfig",
]
...
MIGRATION_MODULES = {"sites": "pythonspain.contrib.sites.migrations"}
...
ADMINS = [("""Python Spain""", "contacto@es.python.org")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = ADMINS

# CELERY
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["pythonspain.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
